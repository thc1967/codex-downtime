...
DTAdjustment = RegisterGameType("DTAdjustment")
...
--- @return DTAdjustment instance The new progress adjustment instance
...
function DTAdjustment:SetAmount(amount)
...
function DTAdjustment:GetServerTime()
